...
function NewPassword(props) {
  ...
  const schema = yup.object().shape({
    ...
    tokenChangePass: yup.string().required("Nhập mã xác thực"),
  });
  ...
  const handleOnSubmit = async function (data) {
    ...
    try {
      ...
      const res = await axios.post(
        "https://onlineauctionserver.herokuapp.com/api/authentication/new-password",
        {
          accPassword: data.accPassword,
          tokenChangePass: data.tokenChangePass,
          accId,
        }
      );
      console.log(res);
